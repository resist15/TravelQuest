...
export default function CollectionDetailsPage() {
  ...
  const fetchCollection = async () => {
    ...
    try {
      const res = await axios.get(`/api/admin/collections/${id}`)
      setCollection(res.data)

      if (res.data.existingAdventureIds.length > 0) {
        const advRes = await axios.get(`/api/admin/collections/${id}/adventures`)
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    ...
                    onClick={async () => {
                      try {
                        await axios.delete(`/api/admin/collections/${collection.id}`);
                ...
                <div className="relative group">
                  ...
                  <Button
                    ...
                    onClick={async (e) => {
                      e.preventDefault()
                      try {
                        await axios.delete(`/api/admin/collections/${collection.id}/adventures/${adv.id}`)
